const functions = {}
functions.TicketsNewTicketAdmin = (message) => 
...
functions.TicketsNewTicketUser = (message) => 
...
functions.TicketsUpdateTicketAdmin = (message) => {
...
functions.TicketsUpdateTicketUser = (message) => {
...
const TicketsTemplates = (message, func) => {
	return functions[func](message)
}	

exports.TicketsTemplates  = TicketsTemplates